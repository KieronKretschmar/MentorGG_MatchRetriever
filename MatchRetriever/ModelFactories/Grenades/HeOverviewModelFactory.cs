...
{
    public class HeOverviewModelFactory : OverviewModelFactory<HeOverviewMapSummary>
    {
        ...
        protected async override Task<HeOverviewMapSummary> GetSummary(long steamId, List<long> matchIds)
        {

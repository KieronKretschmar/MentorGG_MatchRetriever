...
{
    public class HeModelFactory : ZoneModelFactory<HeSample, HeZonePerformance>
    {
        ...
        protected override async Task<ZonePerformanceSummary<HeZonePerformance>> PlayerPerformance(long steamId, List<HeSample> samples, string map, List<long> matchIds)
        {
        ...
        protected override async Task<List<HeSample>> PlayerSamples(long steamId, string map, List<long> matchIds)
        {
